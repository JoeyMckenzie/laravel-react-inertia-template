    ...
    return (
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                <img
                    id="background"
                    className="-left-20 absolute top-0 max-w-[877px]"
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                <a
                                    ...
                                    id="docs-card"
                                    className="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 md:row-span-3 dark:bg-zinc-900 lg:p-10 lg:pb-10 dark:hover:text-white/70 hover:text-black/70 focus:outline-none dark:focus-visible:ring-[#FF2D20] dark:hover:ring-zinc-700 dark:ring-zinc-800 focus-visible:ring-[#FF2D20] hover:ring-black/20"
                                >
                                    <div
                                    ...
                                    >
                                        ...
                                        />
                                        <div className="-bottom-16 -left-16 absolute h-40 w-[calc(100%+8rem)] bg-gradient-to-b from-transparent via-white to-white dark:via-zinc-900 dark:to-zinc-900" />
                                    </div>
                                    ...
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        ...
                                        >
                                            ...
                                            <div className="pt-3 lg:pt-0 sm:pt-5">
                                ...
                                <a
                                    ...
                                    className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 dark:bg-zinc-900 lg:pb-10 dark:hover:text-white/70 hover:text-black/70 focus:outline-none dark:focus-visible:ring-[#FF2D20] dark:hover:ring-zinc-700 dark:ring-zinc-800 focus-visible:ring-[#FF2D20] hover:ring-black/20"
                                >
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 lg:pb-10 dark:ring-zinc-800">
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                            xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            ...
                                            <a
                                                ...
                                                className="rounded-sm underline dark:hover:text-white hover:text-black focus:outline-none dark:focus-visible:ring-[#FF2D20] focus-visible:ring-1 focus-visible:ring-[#FF2D20]"
                                            >
                                                Forge
                                            </a>
                                            ,{" "}
                                            <a
                                                ...
                                                className="rounded-sm underline dark:hover:text-white hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20]"
                                            >
                                                Vapor
                                            </a>
                                            ,{" "}
