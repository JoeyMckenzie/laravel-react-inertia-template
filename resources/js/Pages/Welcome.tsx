                ...
                <div className="p-6 text-end sm:fixed sm:right-0 sm:top-0">
                    {auth.user ? (
                        <Link
                            ...
                            className="font-semibold text-gray-500 hover:text-gray-900 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:text-gray-400 dark:hover:text-white"
                        >
                            Dashboard
                        </Link>
                    ) : (
