    ...
    return (
        <Headless.Switch
            ...
            className={clsx(
                ...
                "forced-colors:outline dark:forced-colors:[--switch-bg:Highlight] forced-colors:[--switch-bg:Highlight]",
                // Unchecked
                "bg-zinc-200 ring-1 ring-black/5 ring-inset dark:bg-white/5 dark:ring-white/15",
                // Checked
                "dark:data-[checked]:bg-[--switch-bg] data-[checked]:bg-[--switch-bg] dark:data-[checked]:ring-[--switch-bg-ring] data-[checked]:ring-[--switch-bg-ring]",
                // Focus
                "focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-blue-500 data-[focus]:outline-offset-2",
                // Hover
