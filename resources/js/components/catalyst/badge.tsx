...
type BadgeProps = { color?: keyof typeof badgeColors };
...
export const BadgeButton = React.forwardRef(function BadgeButton(
    ...
    const classes = clsx(
        className,
        "group relative inline-flex rounded-md focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-blue-500 data-[focus]:outline-offset-2",
    );
