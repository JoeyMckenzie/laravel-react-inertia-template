        ...
        <Headless.Transition appear show={open} {...props}>
            <Headless.Dialog onClose={onClose}>
                <Headless.TransitionChild
                    ...
                    leaveTo="opacity-0"
                >
                    <div className="fixed inset-0 flex w-screen justify-center overflow-y-auto bg-zinc-950/25 px-2 py-2 dark:bg-zinc-950/50 lg:px-8 sm:px-6 lg:py-16 sm:py-8 focus:outline-0" />
                </Headless.TransitionChild>
                        ...
                        >
                            <Headless.DialogPanel
                                className={clsx(
                                    className,
                                    sizes[size],
                                    "row-start-2 w-full min-w-0 rounded-t-3xl bg-white p-[--gutter] shadow-lg ring-1 ring-zinc-950/10 [--gutter:theme(spacing.8)] sm:mb-auto sm:rounded-2xl dark:bg-zinc-900 forced-colors:outline dark:ring-white/10",
                                )}
                            >
                                {children}
                            </Headless.DialogPanel>
